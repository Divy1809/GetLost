...
export default function AIPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black p-8 relative overflow-hidden">
      ...
      <div className="absolute top-32 left-32 w-2 h-2 bg-cyan-400/40 rounded-full"></div>
      <div className="absolute top-48 right-40 w-1 h-1 bg-purple-400/50 rounded-full"></div>
      <div className="absolute bottom-40 left-48 w-1.5 h-1.5 bg-blue-400/40 rounded-full"></div>
      <div className="absolute bottom-32 right-32 w-2 h-2 bg-indigo-400/40 rounded-full"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <button
              onClick={() => navigate(-1)}
              className="group relative bg-gradient-to-r from-slate-800/60 to-slate-700/60 hover:from-slate-700/80 hover:to-slate-600/80 text-white py-4 px-8 rounded-2xl font-semibold text-lg shadow-2xl border border-slate-600/40 hover:border-purple-500/50 backdrop-blur-sm overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 opacity-0 group-hover:opacity-100"></div>
